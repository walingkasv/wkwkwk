...
class Config:
    SECRET_KEY = os.getenv("SECRET_KEY") or "dev-secret-change-this"
    FLASK_DEBUG = os.getenv("FLASK_DEBUG", "false").lower() == "true"

    # Database: gunakan "tidb" untuk produksi / "sqlite" untuk demo lokal cepat.
    ...
    SQLITE_PATH = os.getenv("SQLITE_PATH") or str(Path(tempfile.gettempdir()) / "portfolio_local.db")
    ...
    CONTACT_TO_EMAIL = os.getenv("CONTACT_TO_EMAIL") or os.getenv("RESEND_TO_EMAIL", "")
