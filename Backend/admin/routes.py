...
def dashboard():
    ...
    counts = {
        "skills": db.fetch_one("SELECT COUNT(*) AS total FROM skills WHERE user_id = ?", (user_id,))["total"],
        "experiences": db.fetch_one("SELECT COUNT(*) AS total FROM experiences WHERE user_id = ?", (user_id,))["total"],
        "projects": db.fetch_one("SELECT COUNT(*) AS total FROM projects WHERE user_id = ?", (user_id,))["total"],
        "messages": db.fetch_one("SELECT COUNT(*) AS total FROM contact_messages WHERE status = 'baru'")["total"],
    }
